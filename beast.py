...
class Trader:
    ...
    def calculate_rolling_volatility(self, prices, window):
        ...
        rolling_volatility = log_returns.rolling(window=window).std() * np.sqrt(365)  # annualized volatility
    ...
    def black_scholes(self, state):
        ...
        if rolling_5_spread > 0.7*std_spread:
